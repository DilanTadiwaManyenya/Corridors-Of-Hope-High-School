...
var require_countUp_umd = __commonJS({
  "node_modules/countup.js/dist/countUp.umd.js"(exports2, module2) {
    !(function(t, i) {
      "object" == typeof exports2 && "undefined" != typeof module2 ? i(exports2) : "function" == typeof define && define.amd ? define(["exports"], i) : i((t = "undefined" != typeof globalThis ? globalThis : t || self).countUp = {});
    })(exports2, (function(t) {
      "use strict";
      var i = function() {
        return i = Object.assign || function(t2) {
          for (var i2, e2 = 1, s = arguments.length; e2 < s; e2++) for (var n in i2 = arguments[e2]) Object.prototype.hasOwnProperty.call(i2, n) && (t2[n] = i2[n]);
          return t2;
        }, i.apply(this, arguments);
      }, e = (function() {
        function t2(t3, e2, s) {
          var n = this;
          this.endVal = e2, this.options = s, this.version = "2.10.1", this.defaults = { startVal: 0, decimalPlaces: 0, duration: 2, useEasing: true, useGrouping: true, useIndianSeparators: false, smartEasingThreshold: 999, smartEasingAmount: 333, separator: ",", decimal: ".", prefix: "", suffix: "", autoAnimate: false, autoAnimateDelay: 200, autoAnimateOnce: false }, this.finalEndVal = null, this.useEasing = true, this.countDown = false, this.error = "", this.startVal = 0, this.paused = true, this.once = false, this.count = function(t4) {
            n.startTime || (n.startTime = t4);
            var i2 = t4 - n.startTime;
            n.remaining = n.duration - i2, n.useEasing ? n.countDown ? n.frameVal = n.startVal - n.easingFn(i2, 0, n.startVal - n.endVal, n.duration) : n.frameVal = n.easingFn(i2, n.startVal, n.endVal - n.startVal, n.duration) : n.frameVal = n.startVal + (n.endVal - n.startVal) * (i2 / n.duration);
            var e3 = n.countDown ? n.frameVal < n.endVal : n.frameVal > n.endVal;
            n.frameVal = e3 ? n.endVal : n.frameVal, n.frameVal = Number(n.frameVal.toFixed(n.options.decimalPlaces)), n.printValue(n.frameVal), i2 < n.duration ? n.rAF = requestAnimationFrame(n.count) : null !== n.finalEndVal ? n.update(n.finalEndVal) : n.options.onCompleteCallback && n.options.onCompleteCallback();
          }, this.formatNumber = function(t4) {
            var i2, e3, s2, a, o = t4 < 0 ? "-" : "";
            i2 = Math.abs(t4).toFixed(n.options.decimalPlaces);
            var r = (i2 += "").split(".");
            if (e3 = r[0], s2 = r.length > 1 ? n.options.decimal + r[1] : "", n.options.useGrouping) {
              a = "";
              for (var l = 3, u = 0, h = 0, p = e3.length; h < p; ++h) n.options.useIndianSeparators && 4 === h && (l = 2, u = 1), 0 !== h && u % l == 0 && (a = n.options.separator + a), u++, a = e3[p - h - 1] + a;
              e3 = a;
            }
            return n.options.numerals && n.options.numerals.length && (e3 = e3.replace(/[0-9]/g, (function(t5) {
              return n.options.numerals[+t5];
            })), s2 = s2.replace(/[0-9]/g, (function(t5) {
              return n.options.numerals[+t5];
            }))), o + n.options.prefix + e3 + s2 + n.options.suffix;
          }, this.easeOutExpo = function(t4, i2, e3, s2) {
            return e3 * (1 - Math.pow(2, -10 * t4 / s2)) * 1024 / 1023 + i2;
          }, this.options = i(i({}, this.defaults), s), this.options.enableScrollSpy && (this.options.autoAnimate = true), void 0 !== this.options.scrollSpyDelay && (this.options.autoAnimateDelay = this.options.scrollSpyDelay), this.options.scrollSpyOnce && (this.options.autoAnimateOnce = true), this.formattingFn = this.options.formattingFn ? this.options.formattingFn : this.formatNumber, this.easingFn = this.options.easingFn ? this.options.easingFn : this.easeOutExpo, this.el = "string" == typeof t3 ? document.getElementById(t3) : t3, e2 = null == e2 ? this.parse(this.el.innerHTML) : e2, this.startVal = this.validateValue(this.options.startVal), this.frameVal = this.startVal, this.endVal = this.validateValue(e2), this.options.decimalPlaces = Math.max(this.options.decimalPlaces), this.resetDuration(), this.options.separator = String(this.options.separator), this.useEasing = this.options.useEasing, "" === this.options.separator && (this.options.useGrouping = false), this.el ? this.printValue(this.startVal) : this.error = "[CountUp] target is null or undefined", "undefined" != typeof window && this.options.autoAnimate && (this.error || "undefined" == typeof IntersectionObserver ? this.error ? console.error(this.error, t3) : console.error("IntersectionObserver is not supported by this browser") : this.setupObserver());
        }
        return t2.prototype.setupObserver = function() {
          var i2 = this, e2 = t2.observedElements.get(this.el);
          e2 && e2.unobserve(), t2.observedElements.set(this.el, this), this.observer = new IntersectionObserver((function(t3) {
            for (var e3 = 0, s = t3; e3 < s.length; e3++) {
              var n = s[e3];
              n.isIntersecting && i2.paused && !i2.once ? (i2.paused = false, i2.autoAnimateTimeout = setTimeout((function() {
                return i2.start();
              }), i2.options.autoAnimateDelay), i2.options.autoAnimateOnce && (i2.once = true, i2.observer.disconnect())) : n.isIntersecting || i2.paused || (clearTimeout(i2.autoAnimateTimeout), i2.reset());
            }
          }), { threshold: 0 }), this.observer.observe(this.el);
        }, t2.prototype.unobserve = function() {
          var i2;
          clearTimeout(this.autoAnimateTimeout), null === (i2 = this.observer) || void 0 === i2 || i2.disconnect(), t2.observedElements.delete(this.el);
          ...
          var t3 = null !== this.finalEndVal ? this.finalEndVal : this.endVal;
          ...
          if (Math.abs(i2) > this.options.smartEasingThreshold && this.options.useEasing) {
            this.finalEndVal = t3;
            var e2 = this.countDown ? 1 : -1;
            this.endVal = t3 + e2 * this.options.smartEasingAmount, this.duration = this.duration / 2;
          ...
          if (this.paused) this.startTime = null, this.duration = this.remaining, this.startVal = this.frameVal, this.determineDirectionAndSmartEasing(), this.rAF = requestAnimationFrame(this.count);
            ...
            var t3 = null !== this.finalEndVal ? this.duration + this.remaining : this.remaining;
            this.remaining = t3;
          }
          ...
          var i2;
          if (this.el) {
            var e2 = this.formattingFn(t3);
            if (null === (i2 = this.options.plugin) || void 0 === i2 ? void 0 : i2.render) this.options.plugin.render(this.el, e2);
            else if ("INPUT" === this.el.tagName) this.el.value = e2;
            else "text" === this.el.tagName || "tspan" === this.el.tagName ? this.el.textContent = e2 : this.el.innerHTML = e2;
          }
          ...
          }, e2 = i2(this.options.separator), s = i2(this.options.decimal), n = t3.replace(new RegExp(e2, "g"), "").replace(new RegExp(s, "g"), ".");
          return parseFloat(n);
...
var require_build = __commonJS({
  "node_modules/react-countup/build/index.js"(exports2) {
    "use strict";
    ...
    exports2.default = CountUp2;
    exports2.useCountUp = useCountUp;
  }
});
...
// interop_test.js
var import_react_countup = __toESM(require_build(), 1);
...
// interop_test.js
console.log("CountUp typeof:", typeof import_react_countup.default);
console.log("CountUp.name:", import_react_countup.default && import_react_countup.default.name);
console.log("CountUp has .default:", import_react_countup.default && typeof import_react_countup.default.default);
